...
var arrowSize = exports.arrowSize = 10;
...
function getUpDownPosition(tip, target, state, direction, alignMode, props) {
  ...
  var defaultArrowSpacing = props.arrow ? arrowSize : noArrowDistance;
  var arrowSpacing = typeof props.distance === 'number' ? props.distance : defaultArrowSpacing;
...
function getArrowStyles(target, tip, direction, state, props) {
  ...
  var scrollTop = getScrollTop();
  var scrollLeft = getScrollLeft();
  var arrowSpacing = typeof props.distance === 'number' ? props.distance : arrowSize;
...
function positions(direction, tip, target, state, props) {
  ...
  if (tip && state.showTip) {
    var testArrowStyles = getArrowStyles(target, tip, trimmedDirection, state, props);
    realDirection = (0, _getDirection2.default)(trimmedDirection, tip, target, props.arrow ? arrowSize : 0, bodyPadding, props.arrow && testArrowStyles);
  }
